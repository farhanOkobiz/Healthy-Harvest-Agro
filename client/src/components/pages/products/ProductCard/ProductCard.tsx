    ...
    <div className="productcard">
      <Link href={`/product/${slug}`}>
        <div className="relative group rounded ">
          <div className="absolute top-0 rounded left-0 h-[2px] w-full bg-[#F7B50C] origin-left scale-x-0 transition-transform duration-300 group-hover:scale-x-100 z-10"></div>
