        ...
        {(showCartOverview ||
          ...
          >
            <div className="flex xl:justify-center gap-4 border-b border-black/20 pb-2 ">
              ...
              <Link href="/cart">
                <div className="font-bold text-[#F7B50C] hover:underline">
                  Modify Order
                </div>
              </Link>
            </div>
            ...
            <div className="flex justify-between font-bold text-[16px] py-3 border-t border-black/20">
              <p>subtotal:</p>
              <p className="text-[#F7B50C] text-[20px]">
                ৳{products?.totalPrice}
              </p>
            </div>
            <div className="flex justify-between font-bold text-[16px] py-3">
              <p>Shipping (+):</p>
              <p className="text-[#F7B50C] text-[20px]">৳{shipping}</p>
            </div>
            <div className="flex justify-between font-bold text-[16px] py-3">
              <p>Discount (-):</p>
              <p className="text-[#F7B50C] text-[20px]">
