  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 py-10 lg:py-20">
        <div className="bg-white shadow-lg rounded-2xl p-8 max-w-md text-center space-y-6 mt-12 lg:mt-0">
          <Lottie
          ...
          <Link
            href="/shop"
            className="inline-block bg-[#F7B50C] hover:bg-[#b4d150]  text-white font-semibold px-6 py-2 rounded hover:bg-primary transition duration-300"
          >
            Back to Shop
          </Link>
        </div>
