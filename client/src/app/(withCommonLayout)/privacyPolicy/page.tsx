        ...
        <div className="">
          <div className="p-8">
            <h1 className="text-3xl font-bold text-[#F7B50C] mb-4">
              Privacy Policy - Healthy Harvest Agro
            </h1>
            ...
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#F7B50C] mb-2">
                  ...
                  complete your orders and provide our organic food products and services. The information we collect may include:
                </h2>
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>Name, title, gender, and date of birth</li>
                  <li>Email, postal address, and delivery address (if different)</li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  ...
                  <li>Provide the services and information you request</li>
                  <li>Manage your account with Healthy Harvest Agro</li>
                  ...
                  <li>
                    Contact you via email about other organic food products and services
                    (with your consent)
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>
                    ...
                    couriers or suppliers) to deliver your organic food orders.
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>
                    We may send you updates on organic food products, sales, and promotions.
                  </li>
                  <li>
